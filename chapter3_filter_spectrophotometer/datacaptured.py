...
try:
	...
	while True:
		...
		file = open("data_captured.txt","a")
		file.write("red={0:0.1f} orange={1:0.1f} yellow={2:0.1f} green={3:0.1f} blue={4:0.1f} violet={5:0.1f}".format(red, orange, yellow, green, blue, violet)+"\n")
		file.close()
		#Print the results!
